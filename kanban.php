...
if (!(empty($username) OR empty($password))) {
    ...
    include 'controles/missaoControle.php';
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <form class="form-horizontal" role="form" action="controles/dadosMissao.php" method="POST">
                ...
                if ($numlinha > 0) {
                    ...
                    <div class="row">
                        ...
                        <div id="divIconesMissao" class="col-md-1 control-label"> 
                            ...
                            <div class="modal fade" id="myModalTarefa" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form class="form-horizontal" role="form" action="dadosTarefa.php" method="POST" id="formCriatarefa">
                                            <div class="modal-body">                            
                                                <div class="row">                                
                                                    <div class="form-group">
                                                        <label for="inputNome" class="col-md-2 control-label">Nome:</label>
                            ...
                            <span title="Modificar Missão" data-toggle="tooltip" data-placement="right"> 
                                <a href="#" data-toggle="modal" data-target="#myModalEditarMissao<?php echo $i; ?>" id="m2" >
